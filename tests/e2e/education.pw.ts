...
test("one-editor team rehearsal: baseline, shared practice, frozen final, reveal and debrief", async ({ page, context }) => {
  ...
  expect((await context.request.post("/api/admin/contests",{headers,data:{action:"activate",contestId:state.contestId,expectedVersion:state.schema.version}})).ok()).toBe(true);
